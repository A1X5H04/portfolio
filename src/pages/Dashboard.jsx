  ...
  return (
    <>
      ...
      <div className="my-10 mx-5 md:grid md:grid-cols-2 flex flex-col gap-4 ">
        <div className="border rounded-lg hover:bg-gradient-to-t dark:from-gray-1000 from-slate-100 to-transparent dark:hover:border-gray-800 dark:border-gray-900 border-slate-200 hover:border-slate-300 duration-200 ease-in-out row-span-2">
...
<a href="https://github.com/a1x5h04">
  ...
  />
        ...
        <div className="border rounded-lg hover:bg-gradient-to-t dark:from-gray-1000 from-slate-100 to-transparent dark:hover:border-gray-800 dark:border-gray-900 border-slate-200 hover:border-slate-300 duration-200 ease-in-out row-span-3">
        ...
        <div className="border grid place-items-center rounded-lg hover:bg-gradient-to-t dark:from-gray-1000 from-slate-100 to-transparent dark:hover:border-gray-800 dark:border-gray-900 border-slate-200 hover:border-slate-300 duration-200 ease-in-out">
          <div className="mx-2">
        ...
        <div className="border rounded-lg hover:bg-gradient-to-t dark:from-gray-1000 from-slate-100 to-transparent dark:hover:border-gray-800 dark:border-gray-900 border-slate-200 hover:border-slate-300 duration-200 ease-in-out col-span-2">
